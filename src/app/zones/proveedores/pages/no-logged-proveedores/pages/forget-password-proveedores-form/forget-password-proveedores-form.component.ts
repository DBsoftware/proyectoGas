...
@Component({
  selector: 'app-forget-password-proveedores-form',
  templateUrl: './forget-password-proveedores-form.component.html',
  styleUrls: ['./forget-password-proveedores-form.component.scss']
})
export class ForgetPasswordProveedoresFormComponent implements OnInit {
  ...
  submit() {
    if (this.forgetForm.valid) {
      ...
      this._forgetPassword.remenberPasswordRequest(form, ProveedoresConfig.ZONE_ID)
        .subscribe(data => {
