...
import {ConsultarFechasVencimientoMock} from '../../../../../services/logged-in/consultar-fechas-de-vencimiento-clientes/consultar-fechas-vencimiento-mock';

export class ConsultasFechasVencimientoDatasource implements DataSource<ConsultaFechaVencimientoData> {
