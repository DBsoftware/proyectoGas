...
import { BioDisposicionResiduosParticularesClientesRoutingModule } from './bio-disposicion-residuos-particulares-clientes-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    BioDisposicionResiduosParticularesClientesRoutingModule,
    ReactiveFormsModule,
    MatInputModule,
    MatFormFieldModule,
    MatButtonModule,
  ...
  declarations: [BioDisposicionResiduosParticularesClientesComponent]
})
export class BioDisposicionResiduosParticularesClientesModule { }
